...
public class SearchModule {
    public static void showDashboard() {
        ...
        doctorMenuItem.setOnAction(e -> {
            DoctorSearchModule d=new DoctorSearchModule();
            d.showDoctorModule();
        });
        ...
        patientMenuItem.setOnAction(e -> {
            PatientSearchModule p=new PatientSearchModule();
            p.showPatientModule();
        });
        MenuItem workerMenuItem = new MenuItem("Worker");
        workerMenuItem.setOnAction(e -> {
            workerSearchModule w=new workerSearchModule();
            w.showWorkerModule();
        });

        MenuItem appointmentMenuItem = new MenuItem("Appointment");
        appointmentMenuItem.setOnAction(e -> {
            AppointmentSearchModule ap=new AppointmentSearchModule();
            ap.showAppointmentModule();
        });
        ...
        appointmentMenuItem.setStyle("-fx-font-size: 25;");


        modulesMenu.getItems().addAll( doctorMenuItem,patientMenuItem,workerMenuItem,appointmentMenuItem);
