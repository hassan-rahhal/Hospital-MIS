...
public class Delete {
    public static void showDashboard() {
        ...
        dashboardStage.setTitle("Hospital Management Delete");
        ...
        patientMenuItem.setOnAction(e -> {
            ...
            PatientDeleteModule.showPatientModule();
        });
        MenuItem appointmentMenuItem = new MenuItem("Appointment");
        appointmentMenuItem.setOnAction(e -> {
            handleMenuItemClick("Appointment");
            AppointmentDeleteModule ap=new AppointmentDeleteModule();
        ...
        modulesMenu.getItems().addAll( patientMenuItem,appointmentMenuItem);
